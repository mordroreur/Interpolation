...
\label{sec:orgbc773b3}


\subsection{Cas général des méthodes}
\label{sec:orgb5cb4c1}
...
\label{sec:org2ccb0b4}

Cette fonction permet de faire la somme des différents Li trouvé dans la fonction \hyperref[sec:org61ea95d]{\emph{calculLi}}.
En effet, pour compléter la méthode de Lagrange, il faut faire une boucle \emph{for} qui fait une somme des \(y_i\) multiplier par \hyperref[sec:org61ea95d]{\emph{calculLi}} pour l'itération \(i\).
...
\label{sec:org0588872}

\subsubsection{Affichage}
\label{sec:orgb6213f4}
