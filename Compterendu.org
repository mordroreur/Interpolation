...
** TODO Présentation de la méthode de Newton
...
Après, nous pouvons effectué le calcul des différences divisées en appliquant la formule du cours
...
Subséquemment, si le polynôme renvoie null, alors nous 
#+begin_src C
...
Enfin, nous retournons le polynôme obtenu pour pouvoir l'afficher  dans le terminal, où sous une courbe avec SDL.

* Présentation des Jeux d'essais avec commentaires

Les différents résultats complet sont disponibles en annexe [[*Jeux de Test][ici]].
...
3. Évaluation des coûts (complexité, efficacité):   
   
   
* TODO SDL

** Début
Initialsisation des variables
Stape : sort du jeu si 0
...
#+end_src
souris lieu de la soris
done savoir si le graph est affiché

SDL_Texture (image)  *Graph; : image du graph


Récupérer les évenement (avec event quit)
#+begin_src C
...
TTF_Font pour choisir la police
